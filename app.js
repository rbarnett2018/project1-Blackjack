...
let deck = [
  11, 21, 31, 41, 51, 61, 71, 81, 91, 101, 1011, 10111, 101111, 111, 12, 22, 32,
  42, 52, 62, 72, 82, 92, 102, 1022, 10222, 102222, 112, 13, 23, 33, 43, 53, 63,
  73, 83, 93, 103, 1033, 10333, 103333, 113, 14, 24, 34, 44, 54, 64, 74, 84, 94,
  104, 1044, 10444, 104444, 114,
];
...
function play() {
  ...
  if (cardsInHand.dealerCard2 === aceOH) {
    ...
    dealerCardValues.push(11);
    document.getElementById("oned2").style.display = "initial";
  ...
  if (cardsInHand.dealerCard3 === aceOH) {
    ...
    dealerCardValues.push(11);
    document.getElementById("oned3").style.display = "initial";
  ...
  if (cardsInHand.dealerCard4 === aceOH) {
    ...
    dealerCardValues.push(11);
    document.getElementById("oned4").style.display = "initial";
  ...
  if (cardsInHand.dealerCard5 === aceOH) {
    ...
    dealerCardValues.push(11);
    document.getElementById("oned5").style.display = "initial";
  ...
  if (cardsInHand.dealerCard6 === aceOH) {
    ...
    dealerCardValues.push(11);
    document.getElementById("oned6").style.display = "initial";
  ...
  if (cardsInHand.dealerCard7 === aceOH) {
    ...
    dealerCardValues.push(11);
    document.getElementById("oned7").style.display = "initial";
  ...
  if (cardsInHand.dealerCard8 === aceOH) {
    ...
    dealerCardValues.push(11);
    document.getElementById("oned8").style.display = "initial";
    ...
    dC8 = document.getElementById("dCard8").style.backgroundImage = threeOS;
    1;
    dealerCardValues.push(3);
  ...
  let valueP = playerCardValues.reduce(sum);
    console.log("Players Amount " + valueP + " Dealers Amount " + valueD);
